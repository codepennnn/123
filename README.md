   public void UserPermission()
   {
       ...
       Tracelog(start, EndTime, Task, status);
         ...
         select u.UserId, p.FormId,u.username,f.App_applicationformname,f.description
...
where ( p.AllowRead = 0 or p.AllowWrite = 0 or p.AllowModify = 0 ) and f.Description like 'V - %'

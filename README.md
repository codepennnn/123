    protected void btnSave_Click(object sender, EventArgs e)
    {
...

        {
            ...
            PageRecordDataSet.Tables["App_WorkOrder_Reg"].Rows[0]["BOCW_APPLICABLE_AS_PER_CC"] = PageRecordDataSet.Tables["App_BOCW_Details_workorder"].Rows[0]["BOCW_APPLICABLE_AS_PER_CC"];

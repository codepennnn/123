...

{
...

    {
        ...
        r["Status"] = "Approved";
        r["Remarks"] = r["Remarks"].ToString() + "( CC --" + System.DateTime.Now.ToString("dd/MM/yyyy") + " -- " + Remarks_CC + ")|";
...
else
{
   ...
   output
ok( CC --16/12/2025 -- ok)|
( CC --16/12/2025 -- testing)( CC --16/12/2025 -- ok)|
( CC --16/12/2025 -- testing)( CC --16/12/2025 -- ok)|


why first time my remarks change and other are correct saving why??

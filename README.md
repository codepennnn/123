      <div class="form-inline row">
          <div class="form-group col-md-4 mb-2">
             ...
             <asp:FileUpload ID="WAGE_REGIS_FILE" runat="server" AllowMultiple="true" CssClass="form-control-sm col-sm-9" onchange="return ValidateFileExtension(this)"></asp:FileUpload>
              ...
              <asp:BulletedList  ID="WAGE_REGIS_FILE1" runat="server" DisplayMode="HyperLink" Target="_blank"  OnClick="WAGE_REGIS_FILE1_Click" />
           ...
           <div class="form-group col-md-4 mb-2">
             ...
             <asp:FileUpload ID="BANK_PAY_FILE" runat="server" AllowMultiple="true" CssClass="form-control-sm col-sm-9" onchange="return ValidateFileExtension(this)"></asp:FileUpload>
              <%--<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="BANK_PAY_FILE" ErrorMessage="*" ValidationGroup="save" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
               ...
               <asp:BulletedList  ID="BANK_PAY_FILE1"  runat="server" DisplayMode="HyperLink"  OnClick="BANK_PAY_FILE1_Click" />
         </div>
          <div class="form-group col-md-4 mb-2">
             ...
             <asp:FileUpload ID="GP_DECL_FILE" runat="server" AllowMultiple="true" CssClass="form-control-sm col-sm-9" onchange="return ValidateFileExtension(this)"></asp:FileUpload>
              ...
              <asp:BulletedList  ID="GP_DECL_FILE1"  runat="server" DisplayMode="HyperLink"  OnClick="GP_DECL_FILE1_Click" />
         </div>
          </div>
complete form is here -                <cc1:FormCointainer ID="SummaryReport_Record" runat="server" AllowPaging="True" AutoGenerateColumns="False"
               ...
               DataMember="App_Online_Wages" DataKeyNames="Id,MonthWage,YearWage,V_CODE"
                   ...
                   OnRowDataBound="SummaryReport_Record_RowDataBound"
 ...
 protected void WAGE_REGIS_FILE1_Click(object sender, EventArgs e)
 {
     string path = @"D:/Cybersoft_Doc/CLMS/Attachments/" + PageRecordDataSet.Tables["App_Online_Wages"].Rows[0]["WAGE_REGIS_FILE"].ToString();
    
     String DownloadFilePath = (path);
     if (!File.Exists(DownloadFilePath))
     {
         MyMsgBox.show(CLMS.Control.MyMsgBox.MessageType.Errors, "File Not Found in Specified Path, Please Verify !!!" + DownloadFilePath);
         return;
     }

     Response.AppendHeader("Content-Disposition", "attachment;filename=" + Path.GetFileName(path.Split(new[] { '_' }, 2).GetValue(1).ToString()));
     Response.TransmitFile((path));
     Response.End();

 }

 protected void BANK_PAY_FILE1_Click(object sender, EventArgs e)
 {
     string path = @"D:/Cybersoft_Doc/CLMS/Attachments/" + PageRecordDataSet.Tables["App_Online_Wages"].Rows[0]["BANK_PAY_FILE"].ToString();
     String DownloadFilePath = (path);
     if (!File.Exists(DownloadFilePath))
     {
         MyMsgBox.show(CLMS.Control.MyMsgBox.MessageType.Errors, "File Not Found in Specified Path, Please Verify !!!" + DownloadFilePath);
 ...
 protected void GP_DECL_FILE1_Click(object sender, EventArgs e)
 {
     string path = @"D:/Cybersoft_Doc/CLMS/Attachments/" + PageRecordDataSet.Tables["App_Online_Wages"].Rows[0]["GP_DECL_FILE"].ToString();
     String DownloadFilePath = (path);
     if (!File.Exists(DownloadFilePath))
     {
         MyMsgBox.show(CLMS.Control.MyMsgBox.MessageType.Errors, "File Not Found in Specified Path, Please Verify !!!" + DownloadFilePath);
 ...
 } my link not cliclbale not able to download where is the issue
